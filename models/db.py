...
Field('id_dashboard',db.dashboard,writable=False),
Field('title',requires=IS_NOT_EMPTY()),
Field('bgcolor'),
Field('row','integer',requires=IS_NOT_EMPTY()),
Field('col','integer',requires=IS_NOT_EMPTY()),
Field('colspan','integer'),
Field('chart','reference user_chart'),
format="%(title)s",
)
